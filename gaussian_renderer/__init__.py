...
def render_sphere(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, scaling_modifier=1.0,
           override_color=None):
    """
    Render the scene.
...
def render_panorama(viewpoint_camera, pc: GaussianModel, pipe, bg_color: torch.Tensor, scaling_modifier=1.0,
           override_color=None):
    """
    Render the scene.
    ...
    # Rasterize visible Gaussians to image, obtain their radii (on screen).
    rendered_image, radii = rasterizer(means3D = means3D, means2D = means2D, shs = shs, colors_precomp = colors_precomp, opacities = opacity, scales = scales, rotations = rotations, cov3D_precomp = cov3D_precomp)
    rasterizer.change_viewproj(viewpoint_camera.world_view_transform_right, viewpoint_camera.full_proj_transform_right)
    ...
    rasterizer.change_viewproj(viewpoint_camera.world_view_transform_back, viewpoint_camera.full_proj_transform_back)
    ...
    rasterizer.change_viewproj(viewpoint_camera.world_view_transform_left, viewpoint_camera.full_proj_transform_left)
